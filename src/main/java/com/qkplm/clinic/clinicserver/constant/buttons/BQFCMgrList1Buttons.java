 ...
 */
public class BQFCMgrList1Buttons {
    public static final String ADD = "FCMgrList1:save";
    public static final String EDIT = "FCMgrList1:update";
    public static final String DELETE = "FCMgrList1:delete";
    public static final String SEARCH = "FCMgrList1:search";
    public static final String SET_STATUS = "FCMgrList1:setStatus";
    public static final String UPLOAD = "FCMgrList1:upload";
