...
import com.qkplm.clinic.clinicserver.mapper.BqDrugSalesMapper;
...
/**
* @author Wcke
* @description <p>药房零售表 服务接口类</p>
* @datetime 2026-4-14 12:56
*/
@Service
public class BqDrugSalesServiceImpl extends BaqiServiceImpl<BqDrugSalesMapper, BqDrugSalesEntity> implements IBqDrugSalesService {
