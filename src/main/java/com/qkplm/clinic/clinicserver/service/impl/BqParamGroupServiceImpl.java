...
import com.qkplm.clinic.clinicserver.mapper.BqParamGroupMapper;
...
/**
* @author Wcke
* @description <p>系统参数组表 服务接口类</p>
* @datetime 2024-9-21 9:1
*/
@Service
public class BqParamGroupServiceImpl extends BaqiServiceImpl<BqParamGroupMapper, BqParamGroupEntity> implements IBqParamGroupService {
