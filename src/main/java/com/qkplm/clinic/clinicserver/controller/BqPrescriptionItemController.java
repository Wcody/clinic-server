 ...
 */
@RestController
@RequestMapping("/ams/api/v1/prescription/item")
public class BqPrescriptionItemController {
    private final static String MODULE_NAME = "处方明细表";
    private final static String TAG_NAME = "prescriptionItem";
    private final IBqPrescriptionItemService prescriptionItemService;

    public BqPrescriptionItemController(IBqPrescriptionItemService prescriptionItemService) {
    ...
    */
    ...
    public BqPrescriptionItemEntity get(@PathVariable String id) {
        BqPrescriptionItemEntity prescriptionItem = prescriptionItemService.getById(id);
    ...
    */
    ...
    public Boolean saveBatch(@RequestBody Collection<BqPrescriptionItemEntity> prescriptionItems) {
        if (!prescriptionItemService.saveBatch(prescriptionItems)) {
    ...
    */
    ...
    public BqPrescriptionItemEntity update(@RequestBody BqPrescriptionItemEntity prescriptionItem) {
        if (!prescriptionItemService.updateById(prescriptionItem)) {
    ...
    */
    ...
    public Boolean updateBatch(@RequestBody Collection<BqPrescriptionItemEntity> prescriptionItems) {
        if (!prescriptionItemService.updateBatchById(prescriptionItems)) {
    ...
    */
    ...
    public Boolean delete(@PathVariable String id) {
        if (!prescriptionItemService.removePhysicalById(id)) {
    ...
    */
    ...
    public Boolean deleteBatch(@RequestBody Collection<Serializable> ids) {
        if (!prescriptionItemService.removePhysicalBatchByIds(ids)) {
    ...
    */
    ...
    public Boolean deleteLogic(@PathVariable String id) {
        if (!prescriptionItemService.removeById(id)) {
            throw new BQApiException("删除失败，对象可能不存在");
        }
        return true;
    }
    ...
    */
    ...
    public Boolean deleteLogicBatch(@RequestBody Collection<Serializable> ids) {
        if (!prescriptionItemService.removeBatchByIds(ids)) {
            throw new BQApiException("批量删除失败");
        }
        return true;
    }
    ...
    */
    ...
    public Iterable<BqPrescriptionItemEntity> list(BQSearchParamsGet<BqPrescriptionItemEntity> paramsGet) {
        BQSearchParams<BqPrescriptionItemEntity> params = paramsGet.toSearchParams();
        return prescriptionItemService.list(params.toPage(), params.toWrapper());
    }
    ...
    */
    ...
    public Page<BqPrescriptionItemEntity> page(BQSearchParamsGet<BqPrescriptionItemEntity> paramsGet) {
        BQSearchParams<BqPrescriptionItemEntity> params = paramsGet.toSearchParams();
        return prescriptionItemService.page(params.toPage(), params.toWrapper());
    }
}
