...
import com.qkplm.clinic.clinicserver.service.ITbCheckItemService;
import com.qkplm.clinic.clinicserver.entity.TbCheckItemEntity;
...
public class TbCheckItemController {
    private final static String MODULE_NAME = "检查检验项目表";
    private final static String TAG_NAME = "checkItem";
    private final ITbCheckItemService checkItemService;

    public TbCheckItemController(ITbCheckItemService checkItemService) {
    ...
    */
    ...
    public TbCheckItemEntity get(@PathVariable String id) {
        TbCheckItemEntity checkItem = checkItemService.getById(id);
        if (checkItem == null) {
    ...
    */
    ...
    public TbCheckItemEntity save(@RequestBody TbCheckItemEntity checkItem) {
        checkItem.setEid(null);
    ...
    */
    ...
    public Boolean saveBatch(@RequestBody Collection<TbCheckItemEntity> checkItems) {
        if (!checkItemService.saveBatch(checkItems)) {
    ...
    */
    ...
    public TbCheckItemEntity update(@RequestBody TbCheckItemEntity checkItem) {
    ...
    */
    ...
    public Boolean updateBatch(@RequestBody Collection<TbCheckItemEntity> checkItems) {
        if (!checkItemService.updateBatchById(checkItems)) {
    ...
    */
    ...
    public Boolean delete(@PathVariable String id) {
        if (!checkItemService.removePhysicalById(id)) {
    ...
    */
    ...
    public Boolean deleteBatch(@RequestBody Collection<Serializable> ids) {
        if (!checkItemService.removePhysicalBatchByIds(ids)) {
    ...
    */
    ...
    public Boolean deleteLogicBatch(@RequestBody Collection<Serializable> ids) {
        if (!checkItemService.removeBatchByIds(ids)) {
            throw new BQApiException("批量删除失败");
        }
        return true;
    }
    ...
    */
    ...
    public Iterable<TbCheckItemEntity> list(BQSearchParamsGet<TbCheckItemEntity> paramsGet) {
        BQSearchParams<TbCheckItemEntity> params = paramsGet.toSearchParams();
        return checkItemService.list(params.toPage(), params.toWrapper());
    }
    ...
    */
    ...
    public Page<TbCheckItemEntity> page(BQSearchParamsGet<TbCheckItemEntity> paramsGet) {
        BQSearchParams<TbCheckItemEntity> params = paramsGet.toSearchParams();
        return checkItemService.page(params.toPage(), params.toWrapper());
    }
}
