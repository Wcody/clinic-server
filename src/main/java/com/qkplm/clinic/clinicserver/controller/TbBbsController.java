...
/**
 * @author Wcke
 * @description <p>消息通知 前端控制器</p>
 * @datetime 2025-4-8 11:38
 */
@RestController
@RequestMapping("/ams/api/v1/bbs")
public class TbBbsController {
    private final static String MODULE_NAME = "消息通知";
    private final static String TAG_NAME = "bbs";
    private final ITbBbsService bbsService;

    public TbBbsController(ITbBbsService bbsService) {
    ...
    */
    ...
    public TbBbsEntity get(@PathVariable String id) {
        TbBbsEntity bbs = bbsService.getById(id);
        if (bbs == null) {
    ...
    */
    ...
    public TbBbsEntity save(@RequestBody TbBbsEntity bbs) {
        bbs.setEid(null);
        if (!bbsService.save(bbs)) {
    ...
    */
    ...
    public Boolean saveBatch(@RequestBody Collection<TbBbsEntity> bbss) {
        if (!bbsService.saveBatch(bbss)) {
    ...
    */
    ...
    public TbBbsEntity update(@RequestBody TbBbsEntity bbs) {
        if (!bbsService.updateById(bbs)) {
    ...
    */
    ...
    public Boolean updateBatch(@RequestBody Collection<TbBbsEntity> bbss) {
        if (!bbsService.updateBatchById(bbss)) {
    ...
    */
    ...
    public Boolean delete(@PathVariable String id) {
        if (!bbsService.removePhysicalById(id)) {
    ...
    */
    ...
    public Boolean deleteBatch(@RequestBody Collection<Serializable> ids) {
        if (!bbsService.removePhysicalBatchByIds(ids)) {
    ...
    */
    ...
    public Boolean deleteLogicBatch(@RequestBody Collection<Serializable> ids) {
        if (!bbsService.removeBatchByIds(ids)) {
            throw new BQApiException("批量删除失败");
        }
        return true;
    }
    ...
    */
    ...
    public Iterable<TbBbsEntity> list(BQSearchParamsGet<TbBbsEntity> paramsGet) {
        BQSearchParams<TbBbsEntity> params = paramsGet.toSearchParams();
        return bbsService.list(params.toPage(), params.toWrapper());
    }
    ...
    */
    ...
    public Page<TbBbsEntity> page(BQSearchParamsGet<TbBbsEntity> paramsGet) {
        BQSearchParams<TbBbsEntity> params = paramsGet.toSearchParams();
        return bbsService.page(params.toPage(), params.toWrapper());
    }
}
