...
/**
 * @author Wcke
 * @description <p>科室管理表 前端控制器</p>
 * @datetime 2026-4-14 12:56
 */
@RestController
@RequestMapping("/ams/api/v1/clinic/department")
public class BqClinicDepartmentController {
    private final static String MODULE_NAME = "科室管理表";
    private final static String TAG_NAME = "clinicDepartment";
    private final IBqClinicDepartmentService clinicDepartmentService;

    public BqClinicDepartmentController(IBqClinicDepartmentService clinicDepartmentService) {
    ...
    */
    ...
    public BqClinicDepartmentEntity get(@PathVariable String id) {
        BqClinicDepartmentEntity clinicDepartment = clinicDepartmentService.getById(id);
    ...
    */
    ...
    public BqClinicDepartmentEntity save(@RequestBody BqClinicDepartmentEntity clinicDepartment) {
        clinicDepartment.setId(null);
        if (!clinicDepartmentService.save(clinicDepartment)) {
    ...
    */
    ...
    public Boolean saveBatch(@RequestBody Collection<BqClinicDepartmentEntity> clinicDepartments) {
        if (!clinicDepartmentService.saveBatch(clinicDepartments)) {
    ...
    */
    ...
    public BqClinicDepartmentEntity update(@RequestBody BqClinicDepartmentEntity clinicDepartment) {
        if (!clinicDepartmentService.updateById(clinicDepartment)) {
    ...
    */
    ...
    public Boolean updateBatch(@RequestBody Collection<BqClinicDepartmentEntity> clinicDepartments) {
        if (!clinicDepartmentService.updateBatchById(clinicDepartments)) {
    ...
    */
    ...
    public Boolean delete(@PathVariable String id) {
        if (!clinicDepartmentService.removePhysicalById(id)) {
    ...
    */
    ...
    public Boolean deleteBatch(@RequestBody Collection<Serializable> ids) {
        if (!clinicDepartmentService.removePhysicalBatchByIds(ids)) {
    ...
    */
    ...
    public Boolean deleteLogic(@PathVariable String id) {
        if (!clinicDepartmentService.removeById(id)) {
            throw new BQApiException("删除失败，对象可能不存在");
        }
        return true;
    }
    ...
    */
    ...
    public Boolean deleteLogicBatch(@RequestBody Collection<Serializable> ids) {
        if (!clinicDepartmentService.removeBatchByIds(ids)) {
            throw new BQApiException("批量删除失败");
        }
        return true;
    }
    ...
    */
    ...
    public Iterable<BqClinicDepartmentEntity> list(BQSearchParamsGet<BqClinicDepartmentEntity> paramsGet) {
        BQSearchParams<BqClinicDepartmentEntity> params = paramsGet.toSearchParams();
        return clinicDepartmentService.list(params.toPage(), params.toWrapper());
    }
    ...
    */
    ...
    public Page<BqClinicDepartmentEntity> page(BQSearchParamsGet<BqClinicDepartmentEntity> paramsGet) {
        BQSearchParams<BqClinicDepartmentEntity> params = paramsGet.toSearchParams();
        return clinicDepartmentService.page(params.toPage(), params.toWrapper());
    }
}
