...
import com.qkplm.clinic.clinicserver.service.ITbHolidayService;
...
/**
 * @author Wcke
 * @description <p>节假日配置表 前端控制器</p>
 * @datetime 2024-9-21 9:1
 */
@RestController
@RequestMapping("/ams/api/v1/holiday")
public class TbHolidayController {
    private final static String MODULE_NAME = "节假日配置表";
    private final static String TAG_NAME = "holiday";
    private final ITbHolidayService holidayService;

    public TbHolidayController(ITbHolidayService holidayService) {
    ...
    */
    ...
    public TbHolidayEntity get(@PathVariable String id) {
        TbHolidayEntity holiday = holidayService.getById(id);
        if (holiday == null) {
    ...
    */
    ...
    public TbHolidayEntity save(@RequestBody TbHolidayEntity holiday) {
        holiday.setEid(null);
    ...
    */
    ...
    public Boolean saveBatch(@RequestBody Collection<TbHolidayEntity> holidays) {
        if (!holidayService.saveBatch(holidays)) {
    ...
    */
    ...
    public TbHolidayEntity update(@RequestBody TbHolidayEntity holiday) {
    ...
    */
    ...
    public Boolean updateBatch(@RequestBody Collection<TbHolidayEntity> holidays) {
        if (!holidayService.updateBatchById(holidays)) {
    ...
    */
    ...
    public Boolean delete(@PathVariable String id) {
        if (!holidayService.removePhysicalById(id)) {
    ...
    */
    ...
    public Boolean deleteBatch(@RequestBody Collection<Serializable> ids) {
        if (!holidayService.removePhysicalBatchByIds(ids)) {
    ...
    */
    ...
    public Boolean deleteLogic(@PathVariable String id) {
        if (!holidayService.removeById(id)) {
            throw new BQApiException("删除失败，对象可能不存在");
        }
        return true;
    }
    ...
    */
    ...
    public Boolean deleteLogicBatch(@RequestBody Collection<Serializable> ids) {
        if (!holidayService.removeBatchByIds(ids)) {
            throw new BQApiException("批量删除失败");
        }
        return true;
    }
    ...
    */
    ...
    public Iterable<TbHolidayEntity> list(BQSearchParamsGet<TbHolidayEntity> paramsGet) {
        BQSearchParams<TbHolidayEntity> params = paramsGet.toSearchParams();
        return holidayService.list(params.toPage(), params.toWrapper());
    }
    ...
    */
    ...
    public Page<TbHolidayEntity> page(BQSearchParamsGet<TbHolidayEntity> paramsGet) {
        BQSearchParams<TbHolidayEntity> params = paramsGet.toSearchParams();
        return holidayService.page(params.toPage(), params.toWrapper());
    }
}
