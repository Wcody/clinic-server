...
import com.qkplm.clinic.clinicserver.service.ITbFeeItemService;
import com.qkplm.clinic.clinicserver.entity.TbFeeItemEntity;
...
/**
 * @author Wcke
 * @description <p>收费明细表 前端控制器</p>
 * @datetime 2026-4-9 11:43
 */
@RestController
@RequestMapping("/ams/api/v1/fee/item")
public class TbFeeItemController {
    private final static String MODULE_NAME = "收费明细表";
    private final static String TAG_NAME = "feeItem";
    private final ITbFeeItemService feeItemService;

    public TbFeeItemController(ITbFeeItemService feeItemService) {
    ...
    */
    ...
    public TbFeeItemEntity get(@PathVariable String id) {
        TbFeeItemEntity feeItem = feeItemService.getById(id);
        if (feeItem == null) {
    ...
    */
    ...
    public TbFeeItemEntity save(@RequestBody TbFeeItemEntity feeItem) {
        feeItem.setEid(null);
        if (!feeItemService.save(feeItem)) {
    ...
    */
    ...
    public Boolean saveBatch(@RequestBody Collection<TbFeeItemEntity> feeItems) {
        if (!feeItemService.saveBatch(feeItems)) {
    ...
    */
    ...
    public TbFeeItemEntity update(@RequestBody TbFeeItemEntity feeItem) {
        if (!feeItemService.updateById(feeItem)) {
    ...
    */
    ...
    public Boolean updateBatch(@RequestBody Collection<TbFeeItemEntity> feeItems) {
        if (!feeItemService.updateBatchById(feeItems)) {
    ...
    */
    ...
    public Boolean delete(@PathVariable String id) {
        if (!feeItemService.removePhysicalById(id)) {
    ...
    */
    ...
    public Boolean deleteBatch(@RequestBody Collection<Serializable> ids) {
        if (!feeItemService.removePhysicalBatchByIds(ids)) {
    ...
    */
    ...
    public Boolean deleteLogic(@PathVariable String id) {
        if (!feeItemService.removeById(id)) {
            throw new BQApiException("删除失败，对象可能不存在");
        }
        return true;
    }
    ...
    */
    ...
    public Boolean deleteLogicBatch(@RequestBody Collection<Serializable> ids) {
        if (!feeItemService.removeBatchByIds(ids)) {
            throw new BQApiException("批量删除失败");
        }
        return true;
    }
    ...
    */
    ...
    public Iterable<TbFeeItemEntity> list(BQSearchParamsGet<TbFeeItemEntity> paramsGet) {
        BQSearchParams<TbFeeItemEntity> params = paramsGet.toSearchParams();
        return feeItemService.list(params.toPage(), params.toWrapper());
    }
    ...
    */
    ...
    public Page<TbFeeItemEntity> page(BQSearchParamsGet<TbFeeItemEntity> paramsGet) {
        BQSearchParams<TbFeeItemEntity> params = paramsGet.toSearchParams();
        return feeItemService.page(params.toPage(), params.toWrapper());
    }
}
