...
import com.qkplm.clinic.clinicserver.service.ITbFeeService;
import com.qkplm.clinic.clinicserver.entity.TbFeeEntity;
...
/**
 * @author Wcke
 * @description <p>收费主表 前端控制器</p>
 * @datetime 2026-4-9 11:43
 */
@RestController
@RequestMapping("/ams/api/v1/fee")
public class TbFeeController {
    private final static String MODULE_NAME = "收费主表";
    private final static String TAG_NAME = "fee";
    private final ITbFeeService feeService;

    public TbFeeController(ITbFeeService feeService) {
    ...
    */
    ...
    public TbFeeEntity get(@PathVariable String id) {
        TbFeeEntity fee = feeService.getById(id);
        if (fee == null) {
    ...
    */
    ...
    public TbFeeEntity save(@RequestBody TbFeeEntity fee) {
        fee.setEid(null);
        if (!feeService.save(fee)) {
    ...
    */
    ...
    public Boolean saveBatch(@RequestBody Collection<TbFeeEntity> fees) {
        if (!feeService.saveBatch(fees)) {
    ...
    */
    ...
    public TbFeeEntity update(@RequestBody TbFeeEntity fee) {
        if (!feeService.updateById(fee)) {
    ...
    */
    ...
    public Boolean updateBatch(@RequestBody Collection<TbFeeEntity> fees) {
        if (!feeService.updateBatchById(fees)) {
    ...
    */
    ...
    public Boolean delete(@PathVariable String id) {
        if (!feeService.removePhysicalById(id)) {
    ...
    */
    ...
    public Boolean deleteBatch(@RequestBody Collection<Serializable> ids) {
        if (!feeService.removePhysicalBatchByIds(ids)) {
    ...
    */
    ...
    public Boolean deleteLogicBatch(@RequestBody Collection<Serializable> ids) {
        if (!feeService.removeBatchByIds(ids)) {
            throw new BQApiException("批量删除失败");
        }
        return true;
    }
    ...
    */
    ...
    public Iterable<TbFeeEntity> list(BQSearchParamsGet<TbFeeEntity> paramsGet) {
        BQSearchParams<TbFeeEntity> params = paramsGet.toSearchParams();
        return feeService.list(params.toPage(), params.toWrapper());
    }
    ...
    */
    ...
    public Page<TbFeeEntity> page(BQSearchParamsGet<TbFeeEntity> paramsGet) {
        BQSearchParams<TbFeeEntity> params = paramsGet.toSearchParams();
        return feeService.page(params.toPage(), params.toWrapper());
    }
}
