...
/**
 * @author Wcke
 * @description <p>附加费设置表 前端控制器</p>
 * @datetime 2026-4-14 12:56
 */
@RestController
@RequestMapping("/ams/api/v1/additional/fee")
public class BqAdditionalFeeController {
    private final static String MODULE_NAME = "附加费设置表";
    private final static String TAG_NAME = "additionalFee";
    private final IBqAdditionalFeeService additionalFeeService;

    public BqAdditionalFeeController(IBqAdditionalFeeService additionalFeeService) {
    ...
    */
    ...
    public BqAdditionalFeeEntity get(@PathVariable String id) {
        BqAdditionalFeeEntity additionalFee = additionalFeeService.getById(id);
    ...
    */
    ...
    public BqAdditionalFeeEntity save(@RequestBody BqAdditionalFeeEntity additionalFee) {
        additionalFee.setId(null);
        if (!additionalFeeService.save(additionalFee)) {
    ...
    */
    ...
    public Boolean saveBatch(@RequestBody Collection<BqAdditionalFeeEntity> additionalFees) {
        if (!additionalFeeService.saveBatch(additionalFees)) {
    ...
    */
    ...
    public BqAdditionalFeeEntity update(@RequestBody BqAdditionalFeeEntity additionalFee) {
        if (!additionalFeeService.updateById(additionalFee)) {
    ...
    */
    ...
    public Boolean updateBatch(@RequestBody Collection<BqAdditionalFeeEntity> additionalFees) {
        if (!additionalFeeService.updateBatchById(additionalFees)) {
    ...
    */
    ...
    public Boolean delete(@PathVariable String id) {
        if (!additionalFeeService.removePhysicalById(id)) {
    ...
    */
    ...
    public Boolean deleteBatch(@RequestBody Collection<Serializable> ids) {
        if (!additionalFeeService.removePhysicalBatchByIds(ids)) {
    ...
    */
    ...
    public Boolean deleteLogic(@PathVariable String id) {
        if (!additionalFeeService.removeById(id)) {
            throw new BQApiException("删除失败，对象可能不存在");
        }
        return true;
    }
    ...
    */
    ...
    public Boolean deleteLogicBatch(@RequestBody Collection<Serializable> ids) {
        if (!additionalFeeService.removeBatchByIds(ids)) {
            throw new BQApiException("批量删除失败");
        }
        return true;
    }
    ...
    */
    ...
    public Iterable<BqAdditionalFeeEntity> list(BQSearchParamsGet<BqAdditionalFeeEntity> paramsGet) {
        BQSearchParams<BqAdditionalFeeEntity> params = paramsGet.toSearchParams();
        return additionalFeeService.list(params.toPage(), params.toWrapper());
    }
    ...
    */
    ...
    public Page<BqAdditionalFeeEntity> page(BQSearchParamsGet<BqAdditionalFeeEntity> paramsGet) {
        BQSearchParams<BqAdditionalFeeEntity> params = paramsGet.toSearchParams();
        return additionalFeeService.page(params.toPage(), params.toWrapper());
    }
}
