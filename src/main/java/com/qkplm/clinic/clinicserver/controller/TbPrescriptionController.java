...
public class TbPrescriptionController {
    private final static String MODULE_NAME = "处方主表";
    private final static String TAG_NAME = "prescription";
    private final ITbPrescriptionService prescriptionService;

    public TbPrescriptionController(ITbPrescriptionService prescriptionService) {
    ...
    */
    ...
    public TbPrescriptionEntity get(@PathVariable String id) {
        TbPrescriptionEntity prescription = prescriptionService.getById(id);
    ...
    */
    ...
    public TbPrescriptionEntity save(@RequestBody TbPrescriptionEntity prescription) {
        prescription.setEid(null);
    ...
    */
    ...
    public Boolean saveBatch(@RequestBody Collection<TbPrescriptionEntity> prescriptions) {
    ...
    */
    ...
    public TbPrescriptionEntity update(@RequestBody TbPrescriptionEntity prescription) {
    ...
    */
    ...
    public Boolean updateBatch(@RequestBody Collection<TbPrescriptionEntity> prescriptions) {
    ...
    */
    ...
    public Iterable<TbPrescriptionEntity> list(BQSearchParamsGet<TbPrescriptionEntity> paramsGet) {
        BQSearchParams<TbPrescriptionEntity> params = paramsGet.toSearchParams();
    ...
    */
    ...
    public Page<TbPrescriptionEntity> page(BQSearchParamsGet<TbPrescriptionEntity> paramsGet) {
        BQSearchParams<TbPrescriptionEntity> params = paramsGet.toSearchParams();
