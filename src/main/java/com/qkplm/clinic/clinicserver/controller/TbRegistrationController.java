...
/**
 * @author Wcke
 * @description <p>挂号表 前端控制器</p>
 * @datetime 2026-4-9 11:43
 */
@RestController
@RequestMapping("/ams/api/v1/registration")
public class TbRegistrationController {
    private final static String MODULE_NAME = "挂号表";
    private final static String TAG_NAME = "registration";
    private final ITbRegistrationService registrationService;

    public TbRegistrationController(ITbRegistrationService registrationService) {
    ...
    */
    ...
    public TbRegistrationEntity get(@PathVariable String id) {
        TbRegistrationEntity registration = registrationService.getById(id);
    ...
    */
    ...
    public TbRegistrationEntity save(@RequestBody TbRegistrationEntity registration) {
        registration.setEid(null);
    ...
    */
    ...
    public Boolean saveBatch(@RequestBody Collection<TbRegistrationEntity> registrations) {
    ...
    */
    ...
    public TbRegistrationEntity update(@RequestBody TbRegistrationEntity registration) {
    ...
    */
    ...
    public Boolean updateBatch(@RequestBody Collection<TbRegistrationEntity> registrations) {
    ...
    */
    ...
    public Iterable<TbRegistrationEntity> list(BQSearchParamsGet<TbRegistrationEntity> paramsGet) {
        BQSearchParams<TbRegistrationEntity> params = paramsGet.toSearchParams();
    ...
    */
    ...
    public Page<TbRegistrationEntity> page(BQSearchParamsGet<TbRegistrationEntity> paramsGet) {
        BQSearchParams<TbRegistrationEntity> params = paramsGet.toSearchParams();
