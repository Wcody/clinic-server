...
public class TbPatientController {
    ...
    private final ITbPatientService patientService;

    public TbPatientController(ITbPatientService patientService) {
    ...
    */
    ...
    public TbPatientEntity get(@PathVariable String id) {
        TbPatientEntity patient = patientService.getById(id);
        if (patient == null) {
    ...
    */
    ...
    public TbPatientEntity save(@RequestBody TbPatientEntity patient) {
        patient.setEid(null);
    ...
    */
    ...
    public Boolean saveBatch(@RequestBody Collection<TbPatientEntity> patients) {
    ...
    */
    ...
    public TbPatientEntity update(@RequestBody TbPatientEntity patient) {
    ...
    */
    ...
    public Boolean updateBatch(@RequestBody Collection<TbPatientEntity> patients) {
    ...
    */
    ...
    public Iterable<TbPatientEntity> list(BQSearchParamsGet<TbPatientEntity> paramsGet) {
        BQSearchParams<TbPatientEntity> params = paramsGet.toSearchParams();
    ...
    */
    ...
    public Page<TbPatientEntity> page(BQSearchParamsGet<TbPatientEntity> paramsGet) {
        BQSearchParams<TbPatientEntity> params = paramsGet.toSearchParams();
