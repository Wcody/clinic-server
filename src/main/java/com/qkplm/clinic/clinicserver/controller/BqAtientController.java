...
import com.qkplm.clinic.clinicserver.service.IBqAtientService;
 ...
 */
@RestController
@RequestMapping("/ams/api/v1/atient")
public class BqAtientController {
    private final static String MODULE_NAME = "患者信息表";
    private final static String TAG_NAME = "atient";
    private final IBqAtientService atientService;

    public BqAtientController(IBqAtientService atientService) {
        this.atientService = atientService;
    }
    ...
    */
    ...
    public BqAtientEntity get(@PathVariable String id) {
        BqAtientEntity atient = atientService.getById(id);
        if (atient == null) {
    ...
    */
    ...
    public BqAtientEntity save(@RequestBody BqAtientEntity atient) {
        atient.setId(null);
        if (!atientService.save(atient)) {
    ...
    */
    ...
    public Boolean saveBatch(@RequestBody Collection<BqAtientEntity> atients) {
        if (!atientService.saveBatch(atients)) {
    ...
    */
    ...
    public BqAtientEntity update(@RequestBody BqAtientEntity atient) {
        if (!atientService.updateById(atient)) {
    ...
    */
    ...
    public Boolean updateBatch(@RequestBody Collection<BqAtientEntity> atients) {
        if (!atientService.updateBatchById(atients)) {
    ...
    */
    ...
    public Boolean delete(@PathVariable String id) {
        if (!atientService.removePhysicalById(id)) {
    ...
    */
    ...
    public Boolean deleteBatch(@RequestBody Collection<Serializable> ids) {
        if (!atientService.removePhysicalBatchByIds(ids)) {
    ...
    */
    ...
    public Boolean deleteLogic(@PathVariable String id) {
        if (!atientService.removeById(id)) {
            throw new BQApiException("删除失败，对象可能不存在");
        }
        return true;
    }
    ...
    */
    ...
    public Boolean deleteLogicBatch(@RequestBody Collection<Serializable> ids) {
        if (!atientService.removeBatchByIds(ids)) {
            throw new BQApiException("批量删除失败");
        }
        return true;
    }
    ...
    */
    ...
    public Iterable<BqAtientEntity> list(BQSearchParamsGet<BqAtientEntity> paramsGet) {
        BQSearchParams<BqAtientEntity> params = paramsGet.toSearchParams();
        return atientService.list(params.toPage(), params.toWrapper());
    }
    ...
    */
    ...
    public Page<BqAtientEntity> page(BQSearchParamsGet<BqAtientEntity> paramsGet) {
        BQSearchParams<BqAtientEntity> params = paramsGet.toSearchParams();
        return atientService.page(params.toPage(), params.toWrapper());
    }
}
