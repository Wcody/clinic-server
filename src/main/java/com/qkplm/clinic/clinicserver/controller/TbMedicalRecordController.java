...
public class TbMedicalRecordController {
    private final static String MODULE_NAME = "门诊就诊记录表";
    private final static String TAG_NAME = "medicalRecord";
    private final ITbMedicalRecordService medicalRecordService;

    public TbMedicalRecordController(ITbMedicalRecordService medicalRecordService) {
    ...
    */
    ...
    public TbMedicalRecordEntity get(@PathVariable String id) {
        TbMedicalRecordEntity medicalRecord = medicalRecordService.getById(id);
    ...
    */
    ...
    public TbMedicalRecordEntity save(@RequestBody TbMedicalRecordEntity medicalRecord) {
        medicalRecord.setEid(null);
    ...
    */
    ...
    public Boolean saveBatch(@RequestBody Collection<TbMedicalRecordEntity> medicalRecords) {
    ...
    */
    ...
    public TbMedicalRecordEntity update(@RequestBody TbMedicalRecordEntity medicalRecord) {
    ...
    */
    ...
    public Boolean updateBatch(@RequestBody Collection<TbMedicalRecordEntity> medicalRecords) {
    ...
    */
    ...
    public Iterable<TbMedicalRecordEntity> list(BQSearchParamsGet<TbMedicalRecordEntity> paramsGet) {
        BQSearchParams<TbMedicalRecordEntity> params = paramsGet.toSearchParams();
    ...
    */
    ...
    public Page<TbMedicalRecordEntity> page(BQSearchParamsGet<TbMedicalRecordEntity> paramsGet) {
        BQSearchParams<TbMedicalRecordEntity> params = paramsGet.toSearchParams();
