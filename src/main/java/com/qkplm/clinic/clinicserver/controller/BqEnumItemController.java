...
/**
 * @author Wcke
 * @description <p>枚举子项表 前端控制器</p>
 * @datetime 2024-9-21 9:1
 */
@RestController
@RequestMapping("/ams/api/v1/enum/item")
public class BqEnumItemController {
    private final static String MODULE_NAME = "枚举子项表";
    private final static String TAG_NAME = "enumItem";
    private final IBqEnumItemService enumItemService;

    public BqEnumItemController(IBqEnumItemService enumItemService) {
    ...
    */
    ...
    public BqEnumItemEntity get(@PathVariable String id) {
        BqEnumItemEntity enumItem = enumItemService.getById(id);
        if (enumItem == null) {
    ...
    */
    ...
    public BqEnumItemEntity save(@RequestBody BqEnumItemEntity enumItem) {
        if (!enumItemService.save(enumItem)) {
    ...
    */
    ...
    public Boolean saveBatch(@RequestBody Collection<BqEnumItemEntity> enumItems) {
        if (!enumItemService.saveBatch(enumItems)) {
    ...
    */
    ...
    public BqEnumItemEntity update(@RequestBody BqEnumItemEntity enumItem) {
        if (!enumItemService.updateById(enumItem)) {
    ...
    */
    ...
    public Boolean updateBatch(@RequestBody Collection<BqEnumItemEntity> enumItems) {
        if (!enumItemService.updateBatchById(enumItems)) {
    ...
    */
    ...
    public Boolean delete(@PathVariable String id) {
        if (!enumItemService.removePhysicalById(id)) {
    ...
    */
    ...
    public Boolean deleteBatch(@RequestBody Collection<Serializable> ids) {
        if (!enumItemService.removePhysicalBatchByIds(ids)) {
    ...
    */
    ...
    public Boolean deleteLogic(@PathVariable String id) {
        if (!enumItemService.removeById(id)) {
            throw new BQApiException("删除失败，对象可能不存在");
        }
        return true;
    }
    ...
    */
    ...
    public Boolean deleteLogicBatch(@RequestBody Collection<Serializable> ids) {
        if (!enumItemService.removeBatchByIds(ids)) {
            throw new BQApiException("批量删除失败");
        }
        return true;
    }
    ...
    */
    ...
    public Iterable<BqEnumItemEntity> list(BQSearchParamsGet<BqEnumItemEntity> paramsGet) {
        BQSearchParams<BqEnumItemEntity> params = paramsGet.toSearchParams();
        return enumItemService.list(params.toPage(), params.toWrapper());
    }
    ...
    */
    ...
    public Page<BqEnumItemEntity> page(BQSearchParamsGet<BqEnumItemEntity> paramsGet) {
        BQSearchParams<BqEnumItemEntity> params = paramsGet.toSearchParams();
        return enumItemService.page(params.toPage(), params.toWrapper());
    }
}
