...
<#list table.fields as field>
    <#if field.comment?starts_with("[A]")>
        <#assign hasJsonArray = true>
    </#if>
    <#if field.comment?starts_with("[O]")>
...
/**
* @author ${author}
* @description <p>${table.comment!} 实体类</p>
...
<#list table.fields as field>
    ...
    private ArrayNode ${field.propertyName};
    <#elseif field.comment?starts_with("[O]")>
    @TableField(typeHandler = JacksonTypeHandler.class)
    private ObjectNode ${field.propertyName};
    <#elseif field.comment?starts_with("[B]")>
